...
class MPCWholeBody:
    def __init__(self,
        ...
        obstacle_list,
        N = 10, 
        Q = 5*np.diag([1, 1, 1, 1]), # x, y, z, psi
        P = 50*np.diag([1, 1, 1, 1]), 
        ...
        xlim=np.array([
            [-100, -100, -ca.inf, -2, -2, -ca.pi, -ca.pi/2, -ca.pi*3/4, 0],
    ...
    def reset(self):
        ...
        self.X_ref = self.opti.parameter(self.N+1, 4) # x y z psi of end point, not base
