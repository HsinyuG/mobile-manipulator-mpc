...
def setup_environment(
    ...
    if reconfigure_camera:
        ...
        # env.reconfigure_camera(4.0, 180.0, -90.01, (0.0, 0.0, 0)) # (0, 2, 0) # topview
        # env.reconfigure_camera(4.0, 0.0, -0.0, (0, 0.0, 0.606)) # (0, 2, 0) # backview
        # env.reconfigure_camera(4.0, 90.0, -0.0, (0, 0.0, 0.0)) # (0, 2, 0) # rightview
        # env.reconfigure_camera(4.0, 45.0, -45.0, (2.5, 2.5, 0.606))
